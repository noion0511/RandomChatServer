...
import org.springframework.stereotype.Component
    ...
    class RandomChatManager(
        ...
        private fun startSession(user: User, session: RandomChatSession) {
            ...
            val roomCreated = randomChatRoomManager.createRoomOrWaitAnotherUser(user)
        ...
        private fun sendWelcomeMessage(room: RandomChatRoom) {
            room.users.forEach { user ->
                ...
                randomChatSessionManager.getSession(user)?.sendMessage(message)
            }
        }
        ...
        fun closeSession(userId: Long) {
            ...
            abandoner?.let {
                ...
                val roomAbandoned = randomChatRoomManager.removeUserFromRoom(abandoner)
                roomAbandoned?.let {
        ...
        private fun sendQuitMessage(room: RandomChatRoom, abandoner: User) {
            ...
            room.users.forEach { other ->
                randomChatSessionManager.getSession(other)
